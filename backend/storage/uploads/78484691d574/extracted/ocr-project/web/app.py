...
# Must be set BEFORE pandas/streamlit/numpy/torch/paddle are imported —
# those load their own OpenMP runtime (libiomp5md.dll on Windows), and
# once the first one is loaded, setting this later doesn't help.
