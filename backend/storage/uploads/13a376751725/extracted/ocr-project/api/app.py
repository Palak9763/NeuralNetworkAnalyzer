...
def models():
    return {
        "engine": "PaddleOCR",
        "detection_model": "PP-OCR text detection (DB-based)",
        "recognition_model": "PP-OCR text recognition (CRNN-based)",
        "supports_angle_correction": True,
        "notes": "Fine-tune the recognition model on your own handwriting "
                 "samples if accuracy on your data is too low out of the box.",
    }
