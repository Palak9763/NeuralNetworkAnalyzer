# VENDORED COPY — synced from backend/app/engines\graph\grouping_engine.py
...
from neuralviz._vendored.schemas.graph import GraphGroup, GroupType, UniversalGraph
