# VENDORED COPY — synced from backend/app/engines\graph\universal_graph.py
...
from neuralviz._vendored.engines.pytorch.ast_parser import RawParseResult
from neuralviz._vendored.schemas.graph import (
    Confidence,
    Framework,
    GraphEdge,
    GraphMeta,
