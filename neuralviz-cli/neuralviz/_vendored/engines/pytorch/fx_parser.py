# VENDORED COPY — synced from backend/app/engines\pytorch\fx_parser.py
...
from neuralviz._vendored.engines.pytorch.ast_parser import RawEdge, RawNode, RawParseResult, _find_model_class
